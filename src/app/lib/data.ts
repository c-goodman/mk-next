    ...
    const data = await sql<TRecentGamesMetricsChart>`
      WITH monthly_games AS (
          SELECT
              ...
              COUNT(CASE WHEN players = '4' AND players_4th = ${player} THEN 1 END) AS total_fourths_4_players
          FROM
              mk_form_data
          WHERE
              timestamp >= NOW() - INTERVAL '12 months'
      ...
      SELECT
          ...
          (MAX(mg.total_wins_2_players) / MAX(mg.most_recent_day)) AS avg_wins_per_day_2_players,
          ...
          (MAX(mg.total_seconds_2_players) / MAX(mg.most_recent_day)) AS avg_seconds_per_day_2_players,
          AVG(gpd.daily_games_total_seconds_2_players) AS avg_seconds_per_day_with_data_2_players,
          ...
          (MAX(mg.total_seconds_3_players) / MAX(mg.most_recent_day)) AS avg_seconds_per_day_3_players,
          AVG(gpd.daily_games_total_seconds_3_players) AS avg_seconds_per_day_with_data_3_players,

          /* Total Third Place Metrics */
          MAX(mg.total_thirds_3_players) AS total_thirds_3_players,
          (MAX(mg.total_thirds_3_players) / MAX(mg.most_recent_day)) AS avg_thirds_per_day_3_players,
          AVG(gpd.daily_games_total_thirds_3_players) AS avg_thirds_per_day_with_data_3_players,
          ...
          (MAX(mg.total_seconds_4_players) / MAX(mg.most_recent_day)) AS avg_seconds_per_day_4_players,
          AVG(gpd.daily_games_total_seconds_4_players) AS avg_seconds_per_day_with_data_4_players,

          /* Total Third Place Metrics */
          MAX(mg.total_thirds_4_players) AS total_thirds_4_players,
          (MAX(mg.total_thirds_4_players) / MAX(mg.most_recent_day)) AS avg_thirds_per_day_4_players,
          AVG(gpd.daily_games_total_thirds_4_players) AS avg_thirds_per_day_with_data_4_players,

          /* Total Fourth Place Metrics */
          MAX(mg.total_fourths_4_players) AS total_fourths_4_players,
          (MAX(mg.total_fourths_4_players) / MAX(mg.most_recent_day)) AS avg_fourths_per_day_4_players,
          AVG(gpd.daily_games_total_fourths_4_players) AS avg_fourths_per_day_with_data_4_players
...
//       COUNT(CASE WHEN players_3rd = 'Cooper' THEN 1 END) AS total_thirds,
//       COUNT(CASE WHEN players = '3' AND players_3rd = 'Cooper' THEN 1 END) AS total_thirds_3_players,
//       COUNT(CASE WHEN players = '4' AND players_3rd = 'Cooper' THEN 1 END) AS total_thirds_4_players,
//       COUNT(CASE WHEN players_4th = 'Cooper' THEN 1 END) AS total_fourths,
//       COUNT(CASE WHEN players = '4' AND players_4th = 'Cooper' THEN 1 END) AS total_fourths_4_players
//   FROM
//       mk_form_data
//   WHERE
//       timestamp >= NOW() - INTERVAL '12 months'
...
//       COUNT(CASE WHEN players_2nd = 'Cooper' THEN 1 END) AS daily_games_total_seconds,
//       COUNT(CASE WHEN players_3rd = 'Cooper' THEN 1 END) AS daily_games_total_thirds,
//       COUNT(CASE WHEN players_4th = 'Cooper' THEN 1 END) AS daily_games_total_fourths,
...
//       COUNT(CASE WHEN players = '2' AND players_2nd = 'Cooper' THEN 1 END) AS daily_games_total_seconds_2_players,
...
//       COUNT(CASE WHEN players = '3' AND players_3rd = 'Cooper' THEN 1 END) AS daily_games_total_thirds_3_players,
//       COUNT(CASE WHEN players = '4' AND players_3rd = 'Cooper' THEN 1 END) AS daily_games_total_thirds_4_players,
//       COUNT(CASE WHEN players = '4' AND players_4th = 'Cooper' THEN 1 END) AS daily_games_total_fourths_4_players
//   FROM
//       mk_form_data
//   WHERE
//       timestamp >= NOW() - INTERVAL '12 months'
...
export async function fetchPlayers() {
  try {
    const players = await sql<TPlayerNames>`
      SELECT value AS player_name, COUNT(*) AS count
      FROM (
        SELECT players_1st AS value FROM mk_form_data
        UNION ALL
        SELECT players_2nd FROM mk_form_data
        UNION ALL
        SELECT players_3rd FROM mk_form_data
        UNION ALL
        SELECT players_4th FROM mk_form_data
      ) AS all_players
      ...
      SELECT 'All' AS player_name, MAX(id) AS count
      FROM mk_form_data
